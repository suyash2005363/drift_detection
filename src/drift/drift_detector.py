        ...
        for column in common_columns:
            try:
                ...
                # -----------------------------
                    ...
                    ref_counts = ref_counts.reindex(all_categories, fill_value=1)
                    curr_counts = curr_counts.reindex(all_categories, fill_value=1)

                    # Normalize (important for chi-square)
